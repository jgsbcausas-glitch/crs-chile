...
%s
  ...
  - type: checkboxes
    ...
    attributes:
      ...
      description: Marca solo las que te consten. Cada casilla vale para TODAS las comunas que atiende el CRS.
      options:
%s
  ...
  - type: checkboxes
    ...
    attributes:
      ...
      description: "Vale tanto como lo anterior, pero OJO: marcar acá afirma que el CRS no la lleva en NINGUNA de sus comunas. Si en realidad otra institución la asume solo en algunas (como el CDP Petorca con La Ligua), usa el formulario «Informar que una forma la controla otro establecimiento»."
      options:
%s
